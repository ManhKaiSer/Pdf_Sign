...
namespace SignLibTest
{
    ...
    class Program
    {
        ...
        static void DigitallySignPDFFile(string unsignedDocument, string signedDocument)
        {
            ...
            string pathToTheCertificate = $"D:{Path.DirectorySeparatorChar}Demo{Path.DirectorySeparatorChar}mobi.cer"; //path to your exported public part certificate file (the .CER file)
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                //the project requires Pkcs11Interop library to manage PKCS#11 
                //https://www.nuget.org/packages/Pkcs11Interop/4.0.0
