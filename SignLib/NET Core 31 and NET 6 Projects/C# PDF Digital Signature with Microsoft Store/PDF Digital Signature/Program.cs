    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                //https://www.nuget.org/packages/System.Text.Encoding.CodePages/4.3.0
    ...
    public class ExternalSignature : SignLib.Certificates.IExternalSignature
    {
        ...
        public byte[] ApplySignature(byte[] dataToSign, System.Security.Cryptography.Oid oid)
        {
            ...
            try
            {
                ...
                //RSACng requires https://www.nuget.org/packages/System.Security.Cryptography.Cng/4.5.0

                //perform a simple signature
                System.Security.Cryptography.RSACng rsaSig = new RSACng();
                rsaSig = _cert.PrivateKey as System.Security.Cryptography.RSACng;
                return rsaSig.SignData(dataToSign, hashAlg, RSASignaturePadding.Pkcs1);
            }
            catch (Exception ex)
            {
