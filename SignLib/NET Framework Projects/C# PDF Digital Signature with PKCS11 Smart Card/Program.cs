    ...
    class Program
    {
        ...
        */
        ...
        static void DigitallySignPDFFile(string unsignedDocument, string signedDocument)
        {
            ...
            X509Certificate2Collection selectedCertificate = X509Certificate2UI.SelectFromCollection(smartCardCertificates, "Selecte Certificate", "Selecte the signature certificate", X509SelectionFlag.SingleSelection);
