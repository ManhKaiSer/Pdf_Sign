...
namespace SignLibTest
{
    ...
    class Program
    {
        static X509Certificate2 GetSampleCertificateToVerify()
        {
            try
            {
                ...
                return new X509Certificate2(request.ServicePoint.Certificate.GetRawCertData());
        ...
        static void VerifyCertificate()
        {
            ...
            X509Certificate2 certificate = GetSampleCertificateToVerify();
