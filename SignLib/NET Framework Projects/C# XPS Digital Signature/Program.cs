...
namespace SignLibTest
{
    ...
    class Program
    {
        ...
        */
        ...
        static void DigitallySignXPSDocument(string unsignedDocument, string signedDocument)
        {
            ...
            Console.WriteLine("XPS signature was created." + Environment.NewLine);

        }

        static void VerifyXPSSignature(string signedDocument)
        {
            ...
            Console.WriteLine("Done XPS signature verification." + Environment.NewLine + Environment.NewLine);
        }
        ...
        static void Main(string[] args)
        {
            try
            {
                DigitallySignXPSDocument(Environment.CurrentDirectory + "\\test.xps", Environment.CurrentDirectory + "\\test[signed].xps");

                VerifyXPSSignature(Environment.CurrentDirectory + "\\test[signed].xps");
